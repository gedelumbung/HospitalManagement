	<section class="container">
		...
		<section class="row-fluid">
			<h1 class="box-header"><span class="icon-font"></span> Data Dokter | <?php echo $GLOBALS['site_title']; ?></h1>
			<div class="box">
				<div class="well">
					<?php echo form_open_multipart("admin/data_dokter/simpan"); ?>
				...
				<label for="menu">Nama Dokter</label>
				<div class="cleaner_h5"></div>
				<input type="search" style="width:90%;" id="nama_dokter" name="nama_dokter" placeholder="Nama Dokter" value="<?php echo $nama_dokter; ?>" />
				<div class="cleaner_h10"></div>

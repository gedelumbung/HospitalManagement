			...
			<ul>
				...
				<li class="lp-dropdown">
					...
					<ul class="lp-dropdown-menu simple" data-dropdown-owner="laporan">
						<li>
							<a href="<?php echo base_url(); ?>direktur/laporan_fasilitas_ruang"><i class="icon-th"></i>&nbsp;&nbsp;Laporan Fasilitas Ruang</a>
						</li>
						<li>
							<a href="<?php echo base_url(); ?>direktur/laporan_data_pasien"><i class="icon-file"></i>&nbsp;&nbsp;Laporan Data Pasien</a>
						</li>
						<li>
							<a href="<?php echo base_url(); ?>direktur/laporan_data_ketenagaan"><i class="icon-folder-open"></i>&nbsp;&nbsp;Laporan Data Ketenagaan</a>
						</li>
					</ul>
				</li>
				<li class="lp-dropdown">
					...
					<ul class="lp-dropdown-menu simple" data-dropdown-owner="jadwal">
						<li>
							<a href="<?php echo base_url(); ?>direktur/jadwal_dokter"><i class="icon-hdd"></i>&nbsp;&nbsp;Data Jadwal Dokter</a>
						</li>
						<li>
							<a href="<?php echo base_url(); ?>direktur/jadwal_perawat"><i class="icon-folder-close"></i>&nbsp;&nbsp;Data Jadwal Perawat</a>
						</li>
					</ul>
				</li>
			</ul>
